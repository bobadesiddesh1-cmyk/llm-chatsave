...
(function () {
  ...
  var CSS = [
    ":root{--bg:#ffffff;--fg:#1f2328;--muted:#6b7280;--border:#e5e7eb;--code-bg:#f6f8fa;--code-fg:#1f2328;--user-bg:#f2f4ff;--accent:#6d5ae6;--kw:#a626a4;--str:#50a14f;--com:#9198a1;--num:#986801;}",
    "@media (prefers-color-scheme: dark){:root{--bg:#0d1117;--fg:#e6edf3;--muted:#9198a1;--border:#30363d;--code-bg:#161b22;--code-fg:#e6edf3;--user-bg:#161b2e;--accent:#8b7bf0;--kw:#d2a8ff;--str:#7ee787;--com:#8b949e;--num:#f2cc60;}}",
    ...
    ".tk-doc{max-width:820px;margin:0 auto;padding:40px 24px 24px;}",
    ".tk-header h1{font-size:1.9rem;line-height:1.25;margin:0 0 6px;}",
    ".tk-meta{color:var(--muted);font-size:.85rem;margin:0 0 28px;}",
    ".tk-msg{padding:18px 20px;margin:0 0 18px;border:1px solid var(--border);border-radius:12px;}",
    ".tk-user{background:var(--user-bg);}",
    ".tk-role{display:flex;align-items:baseline;gap:10px;margin-bottom:8px;}",
    ".tk-role-name{font-weight:700;color:var(--accent);font-size:.8rem;letter-spacing:.03em;text-transform:uppercase;}",
    ...
    "blockquote{margin:0 0 14px;padding:2px 16px;border-left:3px solid var(--accent);color:var(--muted);}",
    "code{font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,'Liberation Mono',monospace;font-size:.9em;background:var(--code-bg);padding:.15em .4em;border-radius:5px;}",
    ".tk-code{position:relative;margin:0 0 16px;}",
    ".tk-code pre{margin:0;background:var(--code-bg);color:var(--code-fg);padding:14px 16px;border-radius:10px;overflow-x:auto;border:1px solid var(--border);}",
    ".tk-code pre code{background:none;padding:0;font-size:.86rem;line-height:1.5;white-space:pre;}",
    ".tk-lang{position:absolute;top:0;right:0;background:var(--border);color:var(--muted);font:600 .68rem/1 ui-monospace,monospace;padding:4px 8px;border-radius:0 10px 0 8px;text-transform:uppercase;letter-spacing:.05em;}",
